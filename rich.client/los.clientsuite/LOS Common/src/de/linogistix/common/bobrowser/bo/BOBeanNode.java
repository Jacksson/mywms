...
//        log.log(Level.INFO,"put: " + support.getName());
  ...
  protected void inlineInnerObject(java.beans.PropertyDescriptor p, Map<String, Sheet.Set> nameMap, String groupName, Object inline) {
    try {
      //handle Properties that are plain Objects (Beans)
      BOBeanNode inner;
      Sheet.Set set;
      Object innerObject = p.getReadMethod().invoke(inline, new Object[0]);
      if (innerObject == null) {
