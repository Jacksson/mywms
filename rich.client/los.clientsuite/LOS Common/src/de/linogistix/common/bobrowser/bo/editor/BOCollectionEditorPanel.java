...
public class BOCollectionEditorPanel
                        ...
                        if (this.em.getSelectedNodes()[0] instanceof BOMasterNode) {
                            ...
                            try {
                                ...
                                SwingUtilities.invokeLater(new Runnable() {
                                    ...
                                    public void run() {
                                        mdv.getDetailView().setNodes(new Node[]{en});
                                    }
                                });
                            ...
                            SwingUtilities.invokeLater(new Runnable() {
                                ...
                                public void run() {
                                    mdv.getDetailView().setNodes(new Node[]{em.getSelectedNodes()[0]});
                                }
                            });
                        }
                    }
    ...
    private void initQuery() {
        ...
        try {
            ...
            ((BOQueryMasterDetailView) boQueryPanel.getMasterDetailView()).removeEditButtons();
