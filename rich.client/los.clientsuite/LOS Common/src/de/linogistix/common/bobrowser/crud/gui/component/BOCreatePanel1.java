 ...
 */
final public class BOCreatePanel1 implements Panel{
  
  private BOCreateWizard wizard;
  
  private BOCreateJPanel1  ui;
  ...
  private BOCreateJPanel1 getPanelUI() {
    if (ui == null) {
      ui = new BOCreateJPanel1(wizard.getNode());
    }
    return ui;
  }
  ...
  public void readSettings(Object settings) {
    this.wizard = (BOCreateWizard)settings;
