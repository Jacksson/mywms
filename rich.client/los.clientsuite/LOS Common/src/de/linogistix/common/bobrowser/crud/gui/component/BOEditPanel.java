 ...
 */
final public class BOEditPanel implements Panel{
  
  private BOEditWizard wizard;
  
  private BOEditJPanel1  ui;
  ...
  private BOEditJPanel1 getPanelUI() {
    if (ui == null) {
      ui = new BOEditJPanel1(wizard.getNode());
    }
    return ui;
  }
  ...
  public void readSettings(Object settings) {
    this.wizard = (BOEditWizard)settings;
