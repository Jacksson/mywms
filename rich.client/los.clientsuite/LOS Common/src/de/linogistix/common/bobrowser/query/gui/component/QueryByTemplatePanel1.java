 ...
 */
final public class QueryByTemplatePanel1 implements Panel{
  
  private QueryByTemplateWizard wizard;
  
  private QueryByTemplateJPanel1  ui;
  ...
  private QueryByTemplateJPanel1 getPanelUI() {
    if (ui == null) {
      ui = new QueryByTemplateJPanel1(wizard.getNode());
    }
    return ui;
  }
  ...
  public void readSettings(Object settings) {
    this.wizard = (QueryByTemplateWizard)settings;
