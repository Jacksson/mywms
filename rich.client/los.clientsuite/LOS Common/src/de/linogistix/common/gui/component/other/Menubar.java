...
public class Menubar {
    ...
    private void init() {        
        FileObject fileObj =
                Repository.getDefault().getDefaultFileSystem().getRoot().getFileObject("Menu");
...
//        listItems(name);
    ...
    public List<String> getItems(String path) {
        ...
        FileObject fileObj =
                Repository.getDefault().getDefaultFileSystem().getRoot().getFileObject(path);
        for (FileObject file : fileObj.getChildren()) {
            if (file.isFolder()) {
    ...
    private void hideItem(String path, String name) {
        try {
            FileObject fo = Repository.getDefault().getDefaultFileSystem().getRoot().getFileObject(path);
