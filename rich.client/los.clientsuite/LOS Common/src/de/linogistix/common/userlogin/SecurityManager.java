...
public class SecurityManager {
     ...
     */
    public static boolean login(String username, String password) throws LoginException, J2EEServiceNotAvailable {
        LoginService login;
...
/*        MessageDigest md5;
        ...
        try{
            ...
            FacadeException fex = new FacadeException("Locale could not be set", "BusinessException.LocaleException", new String[]{login.getAuthentification().locale});
