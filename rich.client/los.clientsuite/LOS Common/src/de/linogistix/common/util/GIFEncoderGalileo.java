...
public class GIFEncoderGalileo {
 ...
 * */
    public GIFEncoderGalileo(Image image) throws AWTException {
 ...
 * 256 colors.
 * */
    public GIFEncoderGalileo(byte r[][], byte g[][], byte b[][]) throws AWTException {
