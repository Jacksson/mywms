...
public class ClientItemDataLotFilteringComponent {
    ...
    public ClientItemDataLotFilteringComponent() throws Exception{
        ...
        this(new BOAutoFilteringComboBox<Client>(Client.class),
             new BOAutoFilteringComboBox<ItemData>(ItemData.class),
             new BOAutoFilteringComboBox<Lot>(Lot.class));
    ...
    public ClientItemDataLotFilteringComponent(BOAutoFilteringComboBox<Client> clientCombo,
