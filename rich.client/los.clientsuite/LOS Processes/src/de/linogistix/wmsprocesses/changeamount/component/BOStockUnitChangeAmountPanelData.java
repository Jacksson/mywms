 ...
 */
final public class BOStockUnitChangeAmountPanelData implements WizardDescriptor.ValidatingPanel, PropertyChangeListener,WizardDescriptor.FinishablePanel  {

    private BOStockUnitChangeAmountWizard wizard;
    private DataPanel ui;
    private boolean finishPanel = true;
    /** listener to changes in the wizard */
    private ChangeListener listener;

    @SuppressWarnings("unchecked")
    private DataPanel getPanelUI() {
        if (ui == null) {
            ui = new DataPanel();
    ...
    public void readSettings(Object settings) {
        this.wizard = (BOStockUnitChangeAmountWizard) settings;
