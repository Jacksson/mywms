...
public interface LOSGoodsReceiptComponent {
	 ...
	 */
	public static final String PROPERTY_KEY_PRINTER_GR = "GR_PRINTER_NAME";
	 ...
	 */
	public static final String GR_LIMIT_AMOUNT_TO_NOTIFIED = "GR_LIMIT_AMOUNT_TO_NOTIFIED";
...
//	public LOSStorageLocation createGoodsReceiptLocation(String name);
	...
	public LOSGoodsReceiptPosition createGoodsReceiptPosition(Client client, 
															  ...
															  String qaFault) throws InventoryException;
     ...
     */
    public void assignAdvice(LOSAdvice adv, LOSGoodsReceiptPosition pos) throws InventoryException;
     ...
     * @throws FacadeException 
     */
    void remove(LOSGoodsReceipt r, LOSGoodsReceiptPosition pos) throws InventoryException, FacadeException ;
    ...
    public LOSUnitLoad getOrCreateUnitLoad(Client c,
            LOSStorageLocation sl, UnitLoadType type, String ref) throws LOSLocationException;
