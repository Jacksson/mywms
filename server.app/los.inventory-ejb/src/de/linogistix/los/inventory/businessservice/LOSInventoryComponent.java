...
public interface LOSInventoryComponent extends BasicFacade{
	...
	public StockUnit createStock(Client client, 
								 ...
								 String activityCode, String serialNumber) throws InventoryException;
	...
	public StockUnit createStock(Client client, 
								 ...
								 BigDecimal amount,
								 LOSUnitLoad unitLoad,
								 String activityCode, String serialNumber, String operator, boolean sendNotify) throws InventoryException;
	...
	List<LogItem> sanityCheckStockUnitToDelete();
	List<LogItem> sanityCheckOrder();
	List<LogItem> sanityCheckOrderReceipt();
