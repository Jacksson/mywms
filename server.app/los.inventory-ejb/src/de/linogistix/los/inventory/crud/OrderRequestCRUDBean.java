 ...
 */
@Stateless
public class OrderRequestCRUDBean extends BusinessObjectCRUDBean<LOSOrderRequest> implements OrderRequestCRUDRemote {

	@EJB 
	OrderRequestService service;
	
	@Override
	protected BasicService<LOSOrderRequest> getBasicService() {
