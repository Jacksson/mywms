...
public interface LOSGoodsReceiptFacade {
     ...
     * 
     * The storage location should be of {@link LOSAreaType.GOODS_IN} 
    ...
    public LOSGoodsReceiptPosition createGoodsReceiptPosition(BODTO<Client> client,
            ...
            BigDecimal amount, BODTO<LOSAdvice> advice) throws InventoryException, ReportException;
    /**
    ...
    public LOSGoodsReceiptPosition createGoodsReceiptPositionAndLot(
            ...
            int lock,
            String lockCause
    	) throws InventoryException, ReportException;
     ...
     * @throws de.linogistix.los.inventory.exception.InventoryException
     */
    public void assignLOSAdvice(BODTO<LOSAdvice> adv, LOSGoodsReceipt pos) throws InventoryException;
