...
public class StockUnitQueryBean extends BusinessObjectQueryBean<StockUnit>
	...
	public LOSResultList<BODTO<StockUnit>> queryByTemplateHandles(QueryDetail detail, TemplateQuery query)
...
//		String conditionStr = "WHERE ";
		...
		sbCount.append(UnitLoad.class.getSimpleName()+" ul ");
		...
		sbQuery.append(UnitLoad.class.getSimpleName()+" ul ");
...
//			conditionStr = "AND ";
		...
		List<TemplateQueryWhereToken> wtList = query.getWhereTokens();
