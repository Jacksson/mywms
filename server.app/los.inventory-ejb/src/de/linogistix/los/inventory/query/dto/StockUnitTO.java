...
public class StockUnitTO  extends BODTO<StockUnit>{
	 ...
	 * @param scale
	 */
	public StockUnitTO(Long id, int version, String name, int lock, Lot l, String itemData, String itemDataName, String unitLoad, String storageLocation, BigDecimal amount, BigDecimal reservedAmount, int scale){
	...
	public StockUnitTO(Long id, int version, String name, int lock, String lot, String itemData, String itemDataName, String unitLoad, BigDecimal amount, BigDecimal reservedAmount, int scale){
		super(id, version, name);
		this.lot= lot;
		this.lock = lock;
		this.itemData= itemData;
	...
	public StockUnitTO(StockUnit su){
		super(su.getId(), su.getVersion(), su.getLabelId());
