 ...
 */
@Local
public interface OrderService extends BasicService<LOSOrder> {
     ...
     */
    LOSOrder create(String clientRef, String requestId, OrderType orderType, Date delivery, String destination, String documentUrl, String labelUrl) throws InventoryException;
     ...
     */
    int addPosition(LOSOrder request, ItemData idat, Lot lot, BigDecimal amount, boolean partitionAllowed);
     ...
     */
    public LOSOrder getByRequestId(String requestId) throws EntityNotFoundException;
