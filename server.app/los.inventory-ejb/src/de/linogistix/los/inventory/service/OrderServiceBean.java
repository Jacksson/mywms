...
@Stateless
public class OrderServiceBean extends BasicServiceBean<LOSOrder> implements
		OrderService {

	Logger log = Logger.getLogger(OrderServiceBean.class);
	...
	public LOSOrder create(String clientRef, String requestId,
	...
	public int addPosition(LOSOrder request, ItemData idat, Lot lot,
	...
	public LOSOrder getByRequestId(String requestId)
			throws EntityNotFoundException {

		Query query = manager.createQuery("SELECT o FROM "
				+ LOSOrder.class.getSimpleName() + " o "
				+ "WHERE o.requestId=:requestId");

		query.setParameter("requestId", requestId);

		try {
			LOSOrder o = (LOSOrder) query.getSingleResult();
			return o;
	...
	public void delete(LOSOrder r) {
		r = manager.find(LOSOrder.class, r.getId());
	...
	public List<LOSOrder> getActiveByDestination(LOSStorageLocation dest) {
		Query query = manager.createQuery("SELECT o FROM "
				+ LOSOrder.class.getSimpleName() + " o "
