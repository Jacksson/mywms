 ...
 *  Project myWMS-LOS
 */
package de.linogistix.los.inventory.util;
...
public class InventoryBundleHelper {

	private static final Logger log = Logger.getLogger(InventoryBundleHelper.class);
	
	@SuppressWarnings("unchecked")
	public static final String resolve(Class resolver, String key, Locale locale){
		return resolve(resolver, "Bundle", key, new String[0], locale);
	}
