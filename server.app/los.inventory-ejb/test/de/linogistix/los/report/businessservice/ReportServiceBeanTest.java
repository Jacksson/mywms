...
public class ReportServiceBeanTest extends TestCase {
    ...
    public void testTypeExportExcelGeneric(){
    	...
    	List<LOSStockUnitRecord> l = new ArrayList<LOSStockUnitRecord>();
    	l.add(r);
    	
    	try {
			byte[] bytes = bean.typeExportExcelGeneric("Test Generic Excel Export", l, null);
