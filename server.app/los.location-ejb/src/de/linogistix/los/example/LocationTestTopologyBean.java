...
public class LocationTestTopologyBean implements LocationTestTopologyRemote {
	...
	public void createCapacityConstraints() throws LocationTopologyException,
		...
		if( KOMM_FACH_DUMMY_LHM_CONSTR == null ) {
			...
			KOMM_FACH_DUMMY_LHM_CONSTR.setCapacity(1);
	...
	public void createAreas() throws LocationTopologyException,
		...
		try {
			...
			STORE_AREA.setAreaType(LOSAreaType.STORE);
		...
		try {
			...
			KOMM_AREA.setAreaType(LOSAreaType.PICKING);
		...
		try {
			...
			WE_BEREICH.setAreaType(LOSAreaType.GOODS_IN);
		...
		try {
			...
			WA_BEREICH.setAreaType(LOSAreaType.GOODS_OUT);
		...
		try {
			...
			CLEARING_BEREICH.setAreaType(LOSAreaType.GENERIC);
		...
		try {
			...
			PRODUCTION_BEREICH.setAreaType(LOSAreaType.PRODUCTION);
