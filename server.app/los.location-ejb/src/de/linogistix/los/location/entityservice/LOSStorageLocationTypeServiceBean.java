...
public class LOSStorageLocationTypeServiceBean 
        ...
        implements LOSStorageLocationTypeService{
            ...
            throws UniqueConstraintViolatedException 
    {
        ...
        LOSStorageLocationType type = new LOSStorageLocationType();
        type.setName(name);
    ...
    //----------------------------------------------------------------------
    public LOSTypeCapacityConstraint createTypeCapacityConstraint(String name,
    										 					  ...
    										 					  int capacity) 
    {
        if (slType == null) {
            throw new NullPointerException(
                    "createTypeCapacityConstraint: parameter == null");
        }
        
        LOSTypeCapacityConstraint constr = new LOSTypeCapacityConstraint();
        constr.setName(name);
        constr.setStorageLocationType(slType);
        constr.setUnitLoadType(ulType);
        constr.setCapacity(capacity);
        
        manager.persist(constr);
        
        slType.addTypeCapacityConstraint(constr);
