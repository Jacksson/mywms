...
public class GoodsReceiptBean extends BasicDialogBean {
	Logger log = Logger.getLogger(GoodsReceiptBean.class);
	...
	private LOSSystemPropertyServiceRemote propQuery;
	
	private LOSGoodsReceiptFacade goodsReceiptFacade;
	
	private LOSGoodsReceipt currentGoodsReceipt;
	
	private GoodsReceiptTO selectedGoodsReceiptTO;
	
	private HashMap<String, GoodsReceiptTO> goodsReceiptMap;
	
	private LOSAdvice currentAdvice;
	
	private HashMap<String, LOSAdvice> adviceMap;
	
	private Lot currentLot;
	
	private Date currentValidToDate;
	
	private UnitLoadType currentUnitLoadType;
	
	private BigDecimal currentAmountPerUnitLoad;
	
	private BigDecimal currentPostedAmount = BigDecimal.ZERO;
	
	private int currentAmountOfProcessedUnitLoads = 0;
	
	private HashMap<String, UnitLoadType> unitLoadTypeMap;
	
	private String lotName_Input = "";
	
	private String validTo_Input = "";
	
	private String serialNo_Input = "";
	
	private String amountPerUnitLoad_Input = "";
	
	private String unitLoadLabel_Input = "";
	
	private String stockLabel_Input = "";
	
	private String amountPerStock_Input = "";
	
	private boolean processingSingleStock = false;
	
	private boolean adviceComboBoxChanged = false;
	...
	public String postUnitLoad(){
		...
		int lock = (int)propQuery.getLongDefault(getWorkstationName(), "GOODS_IN_DEFAULT_LOCK", 0);
