...
public class StockTakingBean extends BasicDialogBean {
	...
	private LOSStorageLocation stockTakingLocation;
	
	private String stockTakingLocationName;
	
	private String lastLocationName;
	
	private String unitLoadLabel;
	
	private LOSUnitLoad unitLoadToCount;
	
	private List<LOSUnitLoad> expectedUnitLoadList;
	
	private HashSet<String> countedUnitLoadList;
	
	private String countedAmount;
	
	private QueryUnitLoadServiceRemote queryUnitLoadService;
	
	private QueryStockServiceRemote queryStockService;
	
	private QueryStorageLocationServiceRemote queryLocationService;
	
	private QueryItemDataServiceRemote queryItemData;
	
	private LOSStocktakingFacade stFacade;
	
	private ClientQueryRemote queryClient;
	
	private StockUnit expectedStock;
	
	private List<StockUnit> expectedStockList;
	...
	private int countedStocks = 0;
	
	private List<String> ulTypeList = null;

	private String currentULType = "";
	
	private Client currentClient = null;
	
	private String inputClientNumber = "";
	...
	public String countStocks(){
		...
		try {
			...
			if( !currentClient.equals(unitLoadToCount.getClient()) ) {
	...
	//---------------------------------------------------------------------
	private LOSStorageLocation getStorageLocation(){
