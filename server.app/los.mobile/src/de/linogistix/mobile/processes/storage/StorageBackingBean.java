...
public class StorageBackingBean extends BasicDialogBean{
	...
	private List<LOSStorageRequest> storageRequests;
	private String specialNavigation = null;
	...
	private String notifyFacadeException(FacadeException ex) {
	...
	private String notifyFinish( boolean isDiffLocation ) {
		resetBean();
		List<String> buttonTextList = new ArrayList<String>();
		buttonTextList.add(resolve("Ok", new Object[] {}));
	...
	private String notifyDestinationWrong() {
		List<String> buttonTextList = new ArrayList<String>();
		buttonTextList.add(resolve("Ok", new Object[] {}));
		NotifyDescriptorExt n = new NotifyDescriptorExt(
	...
	private String notifyDestinationWrongButAllowed(final String ul, final String sl, final boolean consolidateCheckBox) {
		List<String> buttonTextList = new ArrayList<String>();
	...
	private String notifyDestinationIsUnitload(final String ul, final String sl) {
		List<String> buttonTextList = new ArrayList<String>();
		buttonTextList.add(resolve("Yes", new Object[] {}));
		buttonTextList.add(resolve("No", new Object[] {}));
		NotifyDescriptorExt n = new NotifyDescriptorExt(
        ...
        try {
            ...
            if( specialNavigation != null ) {
                ...
                if( reqLoc != null ) {
                	...
                	if( ! reqLoc.getName().equals(storageLocationTextField) ) {
                		isDiffLocation = true;
                	}
                }
                
            	return notifyFinish( isDiffLocation );
            }
