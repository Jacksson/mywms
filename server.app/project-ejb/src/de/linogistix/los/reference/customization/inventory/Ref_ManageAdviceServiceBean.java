...
@Stateless
public class Ref_ManageAdviceServiceBean implements ManageAdviceService {
	...
	private static final Logger log = Logger.getLogger(Ref_ManageAdviceServiceBean.class);
	...
	public void updateFromHost(LOSAdvice adv) {
	}
