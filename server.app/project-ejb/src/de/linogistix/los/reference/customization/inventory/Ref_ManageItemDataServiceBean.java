...
@Stateless
public class Ref_ManageItemDataServiceBean implements ManageItemDataService {
	...
	private static final Logger log = Logger.getLogger(Ref_ManageItemDataServiceBean.class);
