...
@Stateless
public class Ref_ManageUnitLoadAdviceServiceBean implements ManageUnitLoadAdviceService 
{
	...
	private static final Logger log = Logger.getLogger(Ref_ManageUnitLoadAdviceServiceBean.class);
	...
	public String getNewAdviceNumber() {
		...
		String no = String.format("%08d", seqService.getNextSequenceNumber(LOSUnitLoadAdvice.class));
	...
	public LOSUnitLoadAdvice createAdvice(Client cl, String adviceNumber, LOSAdviceType type, String labelId) 
	{
		...
		LOSUnitLoadAdvice uadv = new LOSUnitLoadAdvice();
		uadv.setClient(cl);
			...
			throws OutOfRangeException 
	{
		...
		LOSUnitLoadAdvicePosition pos = new LOSUnitLoadAdvicePosition();
